...
export function VideoListPage(props: VideoListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getVideos({
        relations: ['user', 'summary.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['youtube_link.contains', 'transcript.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'youtube_link', header: 'Youtube Link', accessorKey: 'youtube_link' },
    { id: 'transcript', header: 'Transcript', accessorKey: 'transcript' },
    ...
    hasAccess('summary', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Summary',
          accessorKey: 'summary',
          cell: ({ row: { original: record } }: any) => record?._count?.summary,
        }
      : null,
