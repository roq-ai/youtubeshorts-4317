...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Pdfs', path: '/pdfs', entity: 'pdf', service: AccessServiceEnum.PROJECT, icon: FiFile },
    { name: 'Summaries', path: '/summaries', entity: 'summary', service: AccessServiceEnum.PROJECT, icon: FiFileText },
